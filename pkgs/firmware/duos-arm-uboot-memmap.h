/*
 * cvi_board_memmap.h for Milk-V Duo S (Sophgo SG2000, aarch64 U-Boot).
...
/* BL31 / ATF secure monitor */
#define CVIMMAP_MONITOR_ADDR           0x80000000UL

/* FDT passed by prior stage to OpenSBI / BL31 */
...
/* Initial stack pointer: top of U-Boot image window (UIMAG_ADDR + UIMAG_SIZE).
 * SDK value per memmap.py: 0x81800000 + 0x1000000 = 0x82800000. */
