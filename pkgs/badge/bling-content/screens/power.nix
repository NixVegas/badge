...
# detail (rail % of the Li-ion window + VBUS/BAT source) and a rail-level bar. TWO
...
#                                     3.00 V ...... 4.20 V  <- Spleen scale labels
#
...
let
  ...
  # Rail level scaled 3.00..4.20 V (Li-ion window), clamped 0..1.
  frac =
    let
      x = (mv - 3000) * 1.0 / 1200.0;
    in
  ...
  # rail-level bar across the middle, and a Spleen scale row (3.00 V .. 4.20 V)
  ...
  layout64 =
    let
      ...
      # Scale labels along the very bottom: left "3.00 V", right "4.20 V".
      loStr = "3.00 V";
      hiStr = "4.20 V";
